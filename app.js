...
var sql = 'insert into list(text,name,bookname) values(?,?,?)'
connection.query(sql,[text,bookname,name],(err,data)=>{
	if(err){
	console.log(err)
	return
}
...
var sql ='delete from list where uid='+idd
